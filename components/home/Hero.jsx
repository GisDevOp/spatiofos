...
export default function Hero() {
  return (
    <header
      className="relative overflow-hidden bg-[var(--navy-deep)] pt-12 pb-14 md:pt-16 md:pb-16 animate-fade-up"
      role="banner"
    >
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-[rgba(59,191,90,0.12)] border border-[rgba(59,191,90,0.3)] text-[var(--green)] text-xs font-semibold px-3 py-1.5 rounded-full mb-6 font-display tracking-wide">
              ...
              Now booking in South East Queensland
            </div>
            ...
            <p className="text-[15px] text-white/75 leading-relaxed mb-8 max-w-[480px]">
              Detect defects, reduce maintenance costs, and receive professional
              inspection reports with a 24-hour target turnaround. No roof access
              required. Powered by SpatioFos Asset Intelligence™.
            </p>
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 mb-10">
              <Button href="/pricing" variant="primary" className="w-full sm:w-auto justify-center">
                Book Inspection — 50% Off Launch
              </Button>
              <Button href="/asset-intelligence-platform" variant="outlineWhite" className="w-full sm:w-auto justify-center">
                Request Platform Demo
              </Button>
            </div>
            <div
              className="bg-white/[0.04] border border-white/[0.08] rounded-[var(--radius-md)] px-4 sm:px-5 py-3.5 grid grid-cols-2 sm:flex sm:flex-wrap gap-3 sm:gap-4 sm:items-center"
              role="list"
            ...
            >
              {trustItems.map((item) => (
                <div
                  key={item}
                  className="flex items-center gap-2 text-[11px] sm:text-xs font-medium text-white/70"
                  role="listitem"
                >
                  <span
